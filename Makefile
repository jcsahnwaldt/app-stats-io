...
download_apple:
	time ruby download_apple.rb $(APPLE_TOKEN) $(APPLE_VENDOR) $(APPLE_DOWNLOAD_DIR)

download_google:
	time ruby download_google.rb $(GOOGLE_TOKEN) $(GOOGLE_BUCKET) $(GOOGLE_DOWNLOAD_DIR) $(GOOGLE_APP_ID)
