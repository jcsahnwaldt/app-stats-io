...
# Having too many download connections and/or files open at a time can lead to
# errors and slow down the process, so we add a delay. The optimal value depends
# on your network performance and system settings.
